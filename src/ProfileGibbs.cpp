...
public:
  ...
  ParamGLMM(arma::vec beta, // FE parameters
            double sig2,
            arma::mat gamma,
            arma::mat W,
...
ParamGLMM::ParamGLMM(arma::vec beta_, // FE parameters
                     double sig2_,
                     arma::mat gamma_,
                     arma::mat W_,
...
void ParamGLMM::update(DataObj data, int nC, arma::vec Y, arma::ivec Z,  arma::vec cluster_count){
...
)
{
  ...
  ParamGLMM thetaLMM(beta, // FE parameters
                     sig2,
                     gammaLat,
                     WLat,
                     a, //prior invgamma
